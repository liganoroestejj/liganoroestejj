...
const faqs = [
  ...
  { q: "Como posso acessar o ranking atualizado?",  a: "A classificação é atualizada após cada etapa e pode ser acessada na seção Ranking, filtrando por ano e categoria." },
