const features = [
  ...
  { title: "Circuito Completo", desc: "Etapas + Opens ao longo do ano" },
]
  ...
  return (
    <section style={{ padding: "32px 24px", background: "#F9F9F7" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 8 }}>
        ...
        <span style={{ color: "#F0B90B", fontSize: 9, fontWeight: 700, letterSpacing: 4, textTransform: "uppercase" }}>Vantagens</span>
      </div>
      <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 33, color: "#0A0A0A", letterSpacing: 1, marginBottom: 20 }}>Por que se filiar</h2>
      {features.map((f, i) => (
        <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: 14, padding: "14px 0", borderBottom: i < features.length - 1 ? "1px solid #eee" : "none" }}>
          ...
          <div>
            <div style={{ fontSize: 14, fontWeight: 800, color: "#0A0A0A", marginBottom: 3 }}>{f.title}</div>
