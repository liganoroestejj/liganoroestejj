  ...
  return (
    <section style={{ padding: "0 24px 28px" }}>
      <div style={{ background: "#0A0A0A", borderRadius: 10, padding: 24 }}>
        <div style={{ border: "1px solid #F0B90B", color: "#F0B90B", fontSize: 9, fontWeight: 700, letterSpacing: 3, padding: "3px 10px", display: "inline-block", marginBottom: 14 }}>Filiações Abertas</div>
