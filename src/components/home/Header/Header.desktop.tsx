  ...
  return (
    <header style={{ background: "#0A0A0A", padding: "0 60px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 68, position: "sticky", top: 0, zIndex: 50 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        {!user && (
          <Link to="/cadastro" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 3, background: "rgba(255,255,255,0.06)", border: "1px solid #333", borderRadius: 6, padding: "7px 16px", cursor: "pointer", textDecoration: "none" }}>
            ...
            <span style={{ color: "#F0B90B", fontSize: 8, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase" }}>Filiar-se</span>
          </Link>
        )}
        <Link to={user ? "/painel" : "/login"} style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 3, background: "rgba(255,255,255,0.06)", border: "1px solid #333", borderRadius: 6, padding: "7px 16px", cursor: "pointer", textDecoration: "none" }}>
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#F0B90B" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/>
            <circle cx="12" cy="7" r="4"/>
          </svg>
          <span style={{ color: "#F0B90B", fontSize: 8, fontWeight: 700, letterSpacing: 2, textTransform: "uppercase" }}>{user ? "Minha Conta" : "Login"}</span>
        </Link>
      </div>
    </header>
  )
