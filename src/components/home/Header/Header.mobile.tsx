        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 100, display: "flex" }}>
          <div style={{ background: "#0A0A0A", width: "80%", maxWidth: 320, height: "100%", padding: "20px 24px", display: "flex", flexDirection: "column" }}>
            ...
            <nav style={{ display: "flex", flexDirection: "column", gap: 4 }}>
              {navLinks.map((link, i) => (
                <a key={link} href="#" onClick={() => setOpen(false)} style={{ color: i === 0 ? "#F0B90B" : "#ccc", fontSize: 18, fontWeight: 600, textDecoration: "none", padding: "12px 0", borderBottom: "1px solid #1a1a1a", letterSpacing: 1 }}>
                  {link}
                </a>
              ))}
            </nav>
